...
public interface MyList<E> extends Iterable<E> {
	 ...
	 */
	 ...
	 /**
      * Returnes an Element from the list based on it's index if it's present
      * if not it throws an exception.
      * @param index
      * @return E if the element is there
      * @throws IndexOutOfBoundsException if the index is null or greater than the array size
      */
     E get(int index); 
	/**
